...
void xnn_qd8_f16_qb4w_gemm_minmax_ukernel_4x4__scalar(
    ...
    const struct xnn_qd8_quantization_params quantization_params[XNN_MIN_ELEMENTS(4)])
{
  assert(mr != 0);
  assert(mr <= 4);
  assert(nc != 0);
  ...
  do {
    ...
    const float vinput_zero_point2 = (float) quantization_params[2].zero_point;
    const float vinput_zero_point3 = (float) quantization_params[3].zero_point;
    ...
    float vout2x0 = vinput_zero_point2 * vksum0;
    float vout2x1 = vinput_zero_point2 * vksum1;
    float vout2x2 = vinput_zero_point2 * vksum2;
    float vout2x3 = vinput_zero_point2 * vksum3;
    float vout3x0 = vinput_zero_point3 * vksum0;
    float vout3x1 = vinput_zero_point3 * vksum1;
    float vout3x2 = vinput_zero_point3 * vksum2;
    float vout3x3 = vinput_zero_point3 * vksum3;
