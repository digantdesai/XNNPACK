    ...
    const struct xnn_qd8_quantization_params quantization_params[XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    float vout0x2 = (float) vinput_zero_point0 * vksum2;
    float vout0x3 = (float) vinput_zero_point0 * vksum3;
    float vout0x4 = (float) vinput_zero_point0 * vksum4;
    float vout0x5 = (float) vinput_zero_point0 * vksum5;
    float vout0x6 = (float) vinput_zero_point0 * vksum6;
    float vout0x7 = (float) vinput_zero_point0 * vksum7;
